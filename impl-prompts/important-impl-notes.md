...
Since prompt_id is just an FK and not a template system, Codex/Claude should create one minimal prompt/workflow record for the MVP rather than invent a prompt framework.
